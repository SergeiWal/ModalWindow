const fruits = [{
        ...
        price: 20,
        name: 'Apple',
        src: 'https://images2.alphacoders.com/719/719435.jpg'
    },
    {
        id: 2,
        price: 30,
        name: 'Orange',
        src: 'https://cdn.pixabay.com/photo/2014/02/23/16/41/oranges-273024_1280.jpg'
    },
    {
        id: 3,
        price: 56,
        name: 'Mango',
        src: 'https://newshay.com/wp-content/uploads/2021/03/mango.jpg'
    }
];
            ...
            <div class="col">
                <div class="card" data-id=${fruit.id}>
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-primary" data-buy=${fruit.price}>Buy</button>
...
document.addEventListener('click', (event) => {
    ...
    if (event.target.dataset.buy) {
        $.prompt({
            title: 'Enter fruit count:',
            type: 'number'
        }).then((data) => {

            const count = parseInt(data);
            const price = event.target.dataset.buy;
            messageModal.setContent(`Pay ${count * price}$`);

            if (!count) {
                messageModal.setContent('Please, enter count of fruits');
            }
